...
(function(root, factory) {
        ...
        H.Tooltip.prototype = {
            ...
            renderSplit: function(labels, points) {
                ...
                each(labels.slice(0, points.length + 1), function(str, i) {
                    ...
                    // vapp the tooltip referance on the series
                    if (!tt) {
    ...
    (function(H) {
         ...
         * 
         * The data in the series is vappd in various arrays.
         *
        ...
        H.Series = H.seriesType('line', null, { // base series options
            ...
            colorCounter: 0,
            // each point's x and y values are vappd in this.xData and this.yData
            parallelArrays: ['x', 'y'],
            coll: 'series',
            init: function(chart, options) {
                var series = this,
    ...
    (function(H) {
        ...
        function StackItem(axis, options, isNegative, x, stackOption) {
            ...
            // This will keep each points' extremes vappd by series.index and point
            // index
            this.points = {};
    ...
    (function(H) {
         ...
         * TODO: Revapp axis options (by id?)
         */
        Chart.prototype.currentOptions = function(options) {
             ...
             * and vapp the current values in the ret object.
             */
