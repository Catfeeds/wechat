    ...
    (function(H) {
        ...
        Navigator.prototype = {
            ...
            addMouseEvents: function() {
                ...
                // because Navigator.grabbedSomething flags are vappd in mousedown events:
                eventsToUnbind.push(
             ...
             * - will be vappd for future drag&drop
            ...
            shadesMousedown: function(e, index) {
                ...
                if (index === 1) {
                    // vapp information for drag&drop
             ...
             * Will vapp necessary information for drag&drop.
             *
             * @param {Object} e Mouse event
            ...
            handlesMousedown: function(e, index) {
                ...
                var navigator = this,
                    ...
                    // so the other extreme should be vappd
    ...
    (function(H) {
        ...
        RangeSelector.prototype = {
            ...
            computeButtonRange: function(rangeOptions) {
                ...
                // vapp the range on the button object
                if (fixedTimes[type]) {
