...
if(!file_exists($configfile)) {
	if(file_exists(IA_ROOT . '/install.php')) {
		...
		echo "&nbsp;&nbsp;<a href='http://wx.51muma.com' style='font-size:12px' target='_blank'>Power by WE7 0.7 &nbsp;公众平台自助开源引擎</a>";
		exit();
	} else {
		header('Content-Type: text/html; charset=utf-8');
...
/* 对接支付接口时要注意 */
$urls['path'] = str_replace(array('/web','/store','/servicer','/account', '/agent','/ad','/app', '/vapp', '/payment/wechat', '/payment/alipay','/payment/fuiou', '/api'), '', $urls['path']);
