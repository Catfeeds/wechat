...
switch($module){
	case MODULE_NAME_SHOP:
		$url = "{$_W['siteroot']}app/index.php?i={$_W['uniacid']}&c=entry&do=index&m=shop";break;
	case MODULE_NAME_OTO:
		$url = "{$_W['siteroot']}app/index.php?i={$_W['uniacid']}&c=entry&do=index&m=oto";break;
	default:$url = "{$_W['siteroot']}app/index.php?i={$_W['uniacid']}&c=entry&do=index&m=shop";
}
