    ...
    (function(H) {
        ...
        Navigator.prototype = {
            ...
            addMouseEvents: function() {
                ...
                // because Navigator.grabbedSomething flags are accountd in mousedown events:
                eventsToUnbind.push(
             ...
             * - will be accountd for future drag&drop
             ...
             * Will account necessary information for drag&drop.
             *
             * @param {Object} e Mouse event
            ...
            handlesMousedown: function(e, index) {
                ...
                var navigator = this,
                    ...
                    // so the other extreme should be accountd
