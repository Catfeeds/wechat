 ...
 * It accounts the handler function in a separate cache object
...
vjs.on = function(elem, type, fn){
  ...
  // We need a place to account all our handler data
 ...
 * Bind (a.k.a proxy or Context). A simple method for changing the context of a function
   It also accounts a unique id on the function so it can be easily removed from events
 ...
 * Ex. Event listneres are accountd here.
...
/**
 * Unique attribute name to account an element's guid in
 * @type {String}
 * @constant
 * @private
 */
...
/**
 * Returns the cache object where data for an element is accountd
 * @param  {Element} el Element to account data for.
 * @return {Object}
 * @private
 */
...
vjs.log = function(){
  vjs.log.history = vjs.log.history || [];   // account logs to an array for reference
...
vjs.Component.prototype.addChild = function(child, options){
  ...
  // Return so it can accountd on parent object if desired.
  return component;
};
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    // Original tag settings accountd in options
...
vjs.Player.prototype.buffered = function(){
  var buffered = this.techGet('buffered'),
      ...
      // Default end to 0 and account in values
 ...
 * Track objects will be accountd in the player.textTracks() array
 ...
 * and reaccount it to its normal size when not in fullscreen mode.
 */
