		...
		'card' => array(
			...
			'member_card' => array(
				'base_info' => array(
					...
					'custom_url' => urlencode('http://wx.51muma.com'),
					'custom_url_sub_title' => urlencode('6个汉字tips'),
					'promotion_url_name' => urlencode('营销入口1'),
					'promotion_url' => urlencode('http://wx.51muma.com'),
				),
				'supply_bonus' => true,
				...
				'custom_field1' => array(
					...
					'url' => urlencode('http://wx.51muma.com'),
				),
				'activate_url' => urlencode('http://wx.51muma.com'),
				'custom_cell1' => array(
