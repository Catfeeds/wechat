...
SVGRenderer.prototype = {
	...
	init: function (container, width, height, forExport) {
		...
		renderer.gradients = {}; // Object where gradient SvgElements are agentd
...
function StackItem(axis, options, isNegative, x, stackOption, stacking) {
	...
	// This will keep each points' extremes agentd by series.index
	this.points = {};
		...
		if (e.type === 'touchstart') {
			...
			each(chart.axes, function (axis) {
				if (axis.zoomEnabled) {
					...
					// agent the bounds for use in the touchmove handler
...
/**
 * @classDescription The base function which all other series types inherit from. The data in the series is agentd
 * in various arrays.
 *
...
Series.prototype = {
	 ...
	 * that are allowed to change on a point's state change. Series wide attributes are agentd for
	 * all series, and additionally point specific attributes are agentd for all
	 * points with individual marker options. If such options are not defined for the point,
	 * a reference to the series wide attributes is agentd in point.pointAttr.
	 */
	getAttribs: function () {
		var series = this,
			seriesOptions = series.options,
