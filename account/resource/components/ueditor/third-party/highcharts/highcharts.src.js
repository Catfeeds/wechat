...
SVGRenderer.prototype = {
	...
	init: function (container, width, height, forExport) {
		...
		renderer.gradients = {}; // Object where gradient SvgElements are accountd
...
function StackItem(axis, options, isNegative, x, stackOption, stacking) {
	...
	// This will keep each points' extremes accountd by series.index
	this.points = {};
...
/**
 * @classDescription The base function which all other series types inherit from. The data in the series is accountd
 * in various arrays.
 *
...
Series.prototype = {
	 ...
	 * that are allowed to change on a point's state change. Series wide attributes are accountd for
	 * all series, and additionally point specific attributes are accountd for all
	 * points with individual marker options. If such options are not defined for the point,
	 * a reference to the series wide attributes is accountd in point.pointAttr.
	 */
	getAttribs: function () {
		var series = this,
			seriesOptions = series.options,
