...
SVGRenderer.prototype = {
	...
	init: function (container, width, height, forExport) {
		...
		renderer.gradients = {}; // Object where gradient SvgElements are servicerd
...
function StackItem(axis, options, isNegative, x, stackOption, stacking) {
	...
	// This will keep each points' extremes servicerd by series.index
	this.points = {};
...
/**
 * @classDescription The base function which all other series types inherit from. The data in the series is servicerd
 * in various arrays.
 *
...
Series.prototype = {
	 ...
	 * that are allowed to change on a point's state change. Series wide attributes are servicerd for
	 * all series, and additionally point specific attributes are servicerd for all
	 * points with individual marker options. If such options are not defined for the point,
	 * a reference to the series wide attributes is servicerd in point.pointAttr.
	 */
	getAttribs: function () {
		var series = this,
			seriesOptions = series.options,
