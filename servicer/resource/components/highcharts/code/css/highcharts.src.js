...
(function(root, factory) {
    ...
    (function(H) {
         ...
         * 
         * The data in the series is servicerd in various arrays.
         *
        ...
        H.Series = H.seriesType('line', null, { // base series options
            ...
            colorCounter: 0,
            // each point's x and y values are servicerd in this.xData and this.yData
            parallelArrays: ['x', 'y'],
            coll: 'series',
            init: function(chart, options) {
                var series = this,
    ...
    (function(H) {
        ...
        function StackItem(axis, options, isNegative, x, stackOption) {
            ...
            // This will keep each points' extremes servicerd by series.index and point
            // index
            this.points = {};
    ...
    (function(H) {
         ...
         * TODO: Reservicer axis options (by id?)
         */
        Chart.prototype.currentOptions = function(options) {
             ...
             * and servicer the current values in the ret object.
             */
