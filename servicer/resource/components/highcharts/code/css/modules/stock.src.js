    ...
    (function(H) {
        ...
        Navigator.prototype = {
            ...
            addMouseEvents: function() {
                ...
                // because Navigator.grabbedSomething flags are servicerd in mousedown events:
                eventsToUnbind.push(
             ...
             * - will be servicerd for future drag&drop
             ...
             * Will servicer necessary information for drag&drop.
             *
             * @param {Object} e Mouse event
            ...
            handlesMousedown: function(e, index) {
                ...
                var navigator = this,
                    ...
                    // so the other extreme should be servicerd
