...
if($op == 'display'){
    ...
    $pager = mobilePagination(pdo_fetchcolumn("SELECT COUNT(1) FROM ".tablename('sj_news_activity')." WHERE uniacid='{$_W['uniacid']}' AND is_display=1 AND city='{$_W['location']['city']}'"),$page,$psize);
